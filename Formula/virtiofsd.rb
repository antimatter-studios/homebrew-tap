...
# GENERATED by the virtiofsd release pipeline (.github/workflows/release.yml).
...
# Formula/virtiofsd.rb. Do not hand-edit the copy in the tap — it is
